...
class Settings:
    ...
    # IP or hostname of the referee/LB host itself, used for local telemetry labelling.
    # Set REFEREE_HOST in .env if your referee is not on 192.168.0.12.
    referee_host: str = os.getenv("REFEREE_HOST", "192.168.0.12")
